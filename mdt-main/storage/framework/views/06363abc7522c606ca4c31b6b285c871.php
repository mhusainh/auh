<div class="buat-laporan-container">
    <div class="halaman-buat-laporan">
        ...
        <div class="warning-buat-laporan">
            <div>Perlu diingat, meskipun membagikan foto barang yang hilang dapat mempercepat penemuan barang tersebut
            ...
            <div class="detail-input-barang">
                ...
                <div class="lokasi-barang">
                    ...
                    <div class="input-barang"><input type="text"
                            placeholder="Contoh: Jl. Gajah raya, jatuh di depan gajah print" maxlength="60"></div>
                    <div class="ketentuan-penulisan">
                        <div class="text-penulisan">*Tulis alamat terakhir barang sebelum hilang maks. 60 karakter
                        </div>
                ...
                <div class="deskripsi-barang">
                    ...
                    <div class="input-barang">
                        <textarea rows="5" maxlength="380"></textarea>
                    </div>
                    <div class="ketentuan-penulisan">
...
<?php /**PATH C:\Users\LENOVO\Documents\GitHub\WebsiteDataTerminal\mdt\resources\views/components/buat-laporan.blade.php ENDPATH**/ ?>