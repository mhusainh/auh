...
<?php endif; ?>
    ...
    <div class="buat-laporan-container">
        <div class="halaman-buat-laporan">
            ...
            <form action="<?php echo e(route('upload.barang')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="foto-barang">
                            ...
                            <div class="input-gambar">
                                ...
                                <div class="input-barang-1">
                                    <img id="img<?php echo e($i); ?>" src="./img/addfoto<?php echo e($i); ?>.png" alt=""
                                        onclick="triggerFileInput('fileInput<?php echo e($i); ?>')">
                                    <input type="file" id="fileInput<?php echo e($i); ?>" accept="image/*" style="display: none;"
                                        onchange="previewImage(this, 'img<?php echo e($i); ?>')" name="gambar_barang<?php echo e($i); ?>" id="gambar_barang<?php echo e($i); ?>">
                                </div>
                                <?php endfor; ?>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\LENOVO\Documents\GitHub\WebsiteDataTerminal\mdt\resources\views/buat-laporan.blade.php ENDPATH**/ ?>