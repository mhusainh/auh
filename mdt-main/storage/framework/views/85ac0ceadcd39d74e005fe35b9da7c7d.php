...
<?php endif; ?>
    <div class="buat-laporan-container">
        <div class="halaman-buat-laporan">
            ...
            <form action="<?php echo e(route('update.laporan.orang', Crypt::encryptString($orangHilang->id))); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="detail-input-barang">
                        <div class="nama-barang">
                            ...
                            <div class="input-barang"><input type="text"
                                    placeholder="<?php echo e($orangHilang->nama_orang); ?>" maxlength="30" name="nama_barang"
                                    id="nama_barang"></div>
                        ...
                        <div class="lokasi-barang">
                            ...
                            <div class="input-barang"><input type="text"
                                    placeholder="<?php echo e($orangHilang->alamat_barang); ?>" maxlength="60" name="alamat_barang"
                        ...
                        <div class="terakhir-barang">
                            ...
                            <div class="input-barang">
                                <input type="text"
                                    placeholder="<?php echo e(\Carbon\Carbon::parse($orangHilang->created_at)->format('d/m/Y')); ?>"
                                ...
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <div class="input-barang-1">
                                        <img id="img<?php echo e($i); ?>"
                                            src="<?php echo e(!empty($orangHilang->{'gambar_barang' . $i}) ? Storage::url($orangHilang->{'gambar_barang' . $i}) : asset('img/addfoto' . $i . '.png')); ?>"
...
<?php /**PATH C:\Users\LENOVO\Documents\GitHub\WebsiteDataTerminal\mdt\resources\views/edit-laporan-orang.blade.php ENDPATH**/ ?>